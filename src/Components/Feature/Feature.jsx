    ...
    return (
        <div className=" space-y-20">
            <div className=" space-y-20 ">
                ...
                <h3 className=" text-2xl lg:text-5xl font-semibold text-center  lg:w-3/4 mx-auto">With private messaging and calling, you can be yourself, speak freely and feel close to the most important people in your life no matter where they are.</h3>
            ...
            <div className=" lg:flex justify-between items-center space-y-4">
                <div className=" space-y-8 flex-1 md:px-10">
